...
export const DetailCard = ({
  ...
  return (
    <div class="transition delay-150 duration-300 ease-in-out hover:scale-110 relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
