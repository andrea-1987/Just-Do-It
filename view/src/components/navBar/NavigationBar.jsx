...
export function StickyNavbar() {
  ...
  const Welcome = () => {
    if (session !== "") {
      return session
        ? `Welcome ${decodedSession.firstName.toUpperCase()} ${decodedSession.lastName.toUpperCase()}`
        : "Welcome";
    } else {
      return "Welcome";
    }
        ...
        <div className="flex items-center justify-between text-blue-gray-900">
          <div class="flex items-center cursor-pointer">
            <Typography
              onClick={handleHome}
              as="a"
              class="italic text-xl text-gray-700 h1 ms-10 cursor-pointer py-1.5 font-medium "
              variant="text"
            >
              Just Do It
            </Typography>
